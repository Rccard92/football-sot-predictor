...
export function Bookmakers() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-600">
            Recupera e consulta i bookmakers disponibili da API-Sports. La selezione dei bookmaker da usare nel
            modello verrà configurata in uno step successivo.
          </p>
        </div>
        <button
          type="button"
      ...
      {syncMsg ? <p className="text-sm text-emerald-800">{syncMsg}</p> : null}
      {error ? (
      ...
      {loading ? (
        ...
        <p className="text-sm text-slate-600">Nessun bookmaker corrisponde ai filtri.</p>
      ) : (
