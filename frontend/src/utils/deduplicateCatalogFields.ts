...
/** Priorità dedupe solo gruppo «Tiri in porta» (SOT). */
const TIRI_IN_PORTA_ENDPOINT_PRIORITY = [
  'fixtures/statistics',
  'team_match_stats',
  'fixtures/players',
  'players/statistics',
...
/** Priorità dedupe solo gruppo «Cartellini». */
const CARTELLINI_ENDPOINT_PRIORITY = [
  'fixtures/statistics',
  'fixtures/players',
  'fixtures/events',
    ...
    gid === 'tiri'
      ...
      : gid === 'tiri_in_porta'
        ...
        : gid === 'corner'
          ...
          : gid === 'cartellini'
            ? (CARTELLINI_ENDPOINT_PRIORITY as readonly string[])
