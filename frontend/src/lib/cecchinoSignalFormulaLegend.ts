...
export const CECCHINO_SIGNAL_FORMULA_LEGEND: CecchinoSignalFormulaEntry[] = [
  ...
  active(
    ...
    'Si accende quando F36 resta nel range Under, la quota X Cecchino è massimo 3.00, la quota Cecchino 1 è maggiore o uguale alla quota Cecchino 2 e la quota Cecchino Under 2.5 è massimo 2.00.\n\nCondizione: F36 <= 1.53 AND F36 >= -1.50 AND F33 <= 3.00 AND F32 >= F34 AND UNDER2.5 <= 2.00\n\nUNDER2.5 rappresenta la quota Cecchino del mercato Under 2.5 recuperata dal Pannello KPI / goal markets; se assente → NO.',
    UNDER_TARGET,
    UNDER_EVAL,
  ),
  active(
    ...
    'Si accende quando F36 resta in un range Under più stretto, la quota X Cecchino è inferiore a 4.00, la quota Cecchino 1 è maggiore o uguale alla quota Cecchino 2 e la quota Cecchino Under 2.5 è massimo 2.00.\n\nCondizione: F36 <= 1.33 AND F36 >= -1.23 AND F33 < 4.00 AND F32 >= F34 AND UNDER2.5 <= 2.00\n\nUNDER2.5 rappresenta la quota Cecchino del mercato Under 2.5 recuperata dal Pannello KPI / goal markets; se assente → NO.',
    UNDER_TARGET,
    UNDER_EVAL,
  ),
  ...
  active(
    ...
    'Si accende quando F36 è entro ±0,80 con operatori stretti e la quota Cecchino 1 è maggiore o uguale alla quota Cecchino 2.\n\nCondizione: F36 < 0.80 AND F36 > -0.80 AND F32 >= F34\n\nConsenso: il segno X viene acquisito solo con almeno 2 formule SI tra D/E/F/G (policy min-two).',
    DRAW_TARGET,
    DRAW_EVAL,
  ),
  active(
    ...
    'Si accende quando la quota X Cecchino è bassa, F36 resta in area equilibrio e la quota Cecchino 1 è maggiore o uguale alla quota Cecchino 2.\n\nCondizione: F33 < 3.30 AND F36 <= 1.47 AND F36 >= -1.40 AND F32 >= F34\n\nFormula invariata rispetto a V1.',
    DRAW_TARGET,
    DRAW_EVAL,
  ),
  active(
    ...
    'Si accende quando la quota X Cecchino ≤ 2.90 e F36 è entro ±1.70 inclusivi, con F32 >= F34.\n\nCondizione: F33 <= 2.90 AND F36 <= 1.70 AND F36 >= -1.70 AND F32 >= F34',
    DRAW_TARGET,
    DRAW_EVAL,
  ),
  active(
    ...
    'Si accende quando la quota X Cecchino ≤ 3.50 e F36 è entro ±1.20 inclusivi, con F32 >= F34.\n\nCondizione: F33 <= 3.50 AND F36 <= 1.20 AND F36 >= -1.20 AND F32 >= F34',
    DRAW_TARGET,
    DRAW_EVAL,
  ),
