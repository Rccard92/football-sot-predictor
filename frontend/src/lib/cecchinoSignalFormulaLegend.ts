...
export const CECCHINO_SIGNAL_FORMULA_LEGEND: CecchinoSignalFormulaEntry[] = [
  ...
  active(
    ...
    'Si accende quando la quota X è buona, F36 resta entro una fascia compatibile con equilibrio e la quota Cecchino 1 è maggiore o uguale alla quota Cecchino 2.\n\nCondizione: F33 <= 3.00 AND F36 < 2.00 AND F36 > -1.60 AND F32 >= F34',
    DRAW_TARGET,
    DRAW_EVAL,
  ),
