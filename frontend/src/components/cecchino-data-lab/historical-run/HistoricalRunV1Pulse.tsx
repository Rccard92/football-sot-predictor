...
export function HistoricalRunV1Pulse({ overview }: Props) {
  ...
  const cards = [
    ...
    { label: 'Quote N/D', value: k.markets_without_quote ?? k.unavailable_quote_count },
    { label: 'Prob. Cecchino', value: k.with_cecchino_probability },
    { label: 'Fair quote Cecchino', value: k.with_cecchino_fair_quote },
    { label: 'Con rating', value: k.with_rating },
