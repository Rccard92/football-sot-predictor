"""fixture_team_stats: expected_goals (API-Football xG)
...
down_revision: Union[str, Sequence[str], None] = "20260512120000"
...
def upgrade() -> None:
    add_column_if_missing(
        "fixture_team_stats",
        sa.Column("expected_goals", sa.Double(), nullable=True),
    )


def downgrade() -> None:
    drop_column_if_exists("fixture_team_stats", "expected_goals")
