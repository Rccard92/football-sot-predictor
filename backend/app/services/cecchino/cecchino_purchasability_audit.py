...
def resolve_selection_key(panel_row: dict[str, Any]) -> str:
    ...
    if isinstance(raw_key, str) and raw_key.strip():
        ...
        if cand in SELECTION_ALIASES.values() or cand in {
            SEL_HOME, SEL_DRAW, SEL_AWAY, SEL_HOME_PT, SEL_DRAW_PT, SEL_AWAY_PT,
            SEL_ONE_X, SEL_X_TWO, SEL_ONE_TWO,
            SEL_OVER_1_5, SEL_UNDER_1_5, SEL_OVER_2_5, SEL_UNDER_2_5,
            SEL_OVER_3_5, SEL_UNDER_3_5,
            SEL_OVER_PT_0_5, SEL_UNDER_PT_0_5, SEL_OVER_PT_1_5, SEL_UNDER_PT_1_5,
        }:
            return cand
