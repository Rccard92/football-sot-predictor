...
BALANCE_MONITORING_SNAPSHOT_VERSION = "cecchino_balance_v5_monitoring_snapshot_v2"
    ...
    return make_json_safe(
        {
            ...
            "source_mode": source_mode,
            # f36_index / f36_class = indice e classe FINALI visualizzati (V3)
            "f36_index": f36.get("index"),
            "f36_class": f36.get("class_label") or f36.get("class_key"),
            "f36_base_index": f36.get("base_index"),
            "f36_base_class": f36.get("base_class_label") or f36.get("base_class_key"),
            "f36_adjusted_index": f36.get("adjusted_index", f36.get("index")),
            "f36_adjusted_class": f36.get("adjusted_class_label") or f36.get("class_label"),
            "quota_x_book": f36.get("quota_x_book"),
            "quota_x_cecchino": f36.get("quota_x_cecchino"),
            "quota_x_media": f36.get("quota_x_media"),
            "x_mean_threshold": f36.get("x_mean_threshold"),
            "x_mean_delta": f36.get("x_mean_delta"),
            "x_mean_strength": f36.get("x_mean_strength"),
            "x_mean_direction": f36.get("x_mean_direction"),
            "x_mean_adjustment": f36.get("x_mean_adjustment"),
            "x_mean_source_status": f36.get("x_mean_source_status"),
...
def _row_from_resolve(
    ...
    return {
        ...
        "f36_base_index": payload.get("f36_base_index"),
        "f36_base_class": payload.get("f36_base_class"),
        "f36_adjusted_index": payload.get("f36_adjusted_index", payload.get("f36_index")),
        "f36_adjusted_class": payload.get("f36_adjusted_class", payload.get("f36_class")),
        "quota_x_book": payload.get("quota_x_book"),
        "quota_x_cecchino": payload.get("quota_x_cecchino"),
        "quota_x_media": payload.get("quota_x_media"),
        "x_mean_threshold": payload.get("x_mean_threshold"),
        "x_mean_delta": payload.get("x_mean_delta"),
        "x_mean_strength": payload.get("x_mean_strength"),
        "x_mean_direction": payload.get("x_mean_direction"),
        "x_mean_adjustment": payload.get("x_mean_adjustment"),
        "x_mean_source_status": payload.get("x_mean_source_status"),
