...
def verify_complete_1x2_odds(
    ...
    if missing_books:
        ...
        reason = "missing_1x2_market" if any_raw else "missing_bookmaker"
        return False, {"bookmakers": book_snapshots, "missing": missing_books}, reason
