...
MARKET_COMPLETE_SETS: dict[tuple[str, str, float | None], frozenset[str]] = {
    ...
    (FAMILY_MATCH_WINNER, PERIOD_HT, None): frozenset(
        {SEL_HOME_PT, SEL_DRAW_PT, SEL_AWAY_PT}
    ),
    (FAMILY_OVER_UNDER, PERIOD_FT, 1.5): frozenset({SEL_OVER_1_5, SEL_UNDER_1_5}),
    (FAMILY_OVER_UNDER, PERIOD_FT, 2.5): frozenset({SEL_OVER_2_5, SEL_UNDER_2_5}),
    (FAMILY_OVER_UNDER, PERIOD_FT, 3.5): frozenset({SEL_OVER_3_5, SEL_UNDER_3_5}),
    (FAMILY_OVER_UNDER, PERIOD_HT, 0.5): frozenset({SEL_OVER_PT_0_5, SEL_UNDER_PT_0_5}),
...
_OPPOSITION_MAP: dict[str, dict[str, Any]] = {
    ...
    SEL_HOME_PT: _entry(
        raw_market_code=SEL_HOME_PT,
        canonical_market_family=FAMILY_MATCH_WINNER,
        period=PERIOD_HT,
        line=None,
        selection=SEL_HOME_PT,
        comparators=[SEL_AWAY_PT],
        complement=None,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_DRAW_PT: _entry(
        ...
        comparators=[SEL_HOME_PT, SEL_AWAY_PT],
        complement=None,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_AWAY_PT: _entry(
        raw_market_code=SEL_AWAY_PT,
        canonical_market_family=FAMILY_MATCH_WINNER,
        period=PERIOD_HT,
        line=None,
        selection=SEL_AWAY_PT,
        comparators=[SEL_HOME_PT],
        complement=None,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_ONE_X: _entry(
    ...
    SEL_OVER_1_5: _entry(
        ...
        comparators=[SEL_UNDER_1_5],
        complement=SEL_UNDER_1_5,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_UNDER_1_5: _entry(
        raw_market_code=SEL_UNDER_1_5,
        canonical_market_family=FAMILY_OVER_UNDER,
        period=PERIOD_FT,
        line=1.5,
        selection=SEL_UNDER_1_5,
        comparators=[SEL_OVER_1_5],
        complement=SEL_OVER_1_5,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_OVER_2_5: _entry(
    ...
    SEL_OVER_3_5: _entry(
        raw_market_code=SEL_OVER_3_5,
        canonical_market_family=FAMILY_OVER_UNDER,
        period=PERIOD_FT,
        line=3.5,
        selection=SEL_OVER_3_5,
        comparators=[SEL_UNDER_3_5],
        complement=SEL_UNDER_3_5,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_UNDER_3_5: _entry(
        ...
        comparators=[SEL_OVER_3_5],
        complement=SEL_OVER_3_5,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_OVER_PT_0_5: _entry(
        ...
        comparators=[SEL_UNDER_PT_0_5],
        complement=SEL_UNDER_PT_0_5,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
    SEL_UNDER_PT_0_5: _entry(
        raw_market_code=SEL_UNDER_PT_0_5,
        canonical_market_family=FAMILY_OVER_UNDER,
        period=PERIOD_HT,
        line=0.5,
        selection=SEL_UNDER_PT_0_5,
        comparators=[SEL_OVER_PT_0_5],
        complement=SEL_OVER_PT_0_5,
        opposition_status=OPPOSITION_SUPPORTED,
    ),
