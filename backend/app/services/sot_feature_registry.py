...
V11_MODEL_STAGE = "offensive_defense_split_recent_xg_player_profile"
V11_MIN_COMPLETED_MATCHES = 5
V11_MIN_SPLIT_MATCHES = 5
V11_MIN_RECENT_MATCHES = 5
V11_MIN_XG_MATCHES = 5
V11_MIN_PLAYER_MINUTES = 180
V11_MIN_PLAYER_PROFILE_PLAYERS = 3
V11_TOP_PLAYERS_USED = 5
V11_FORMULA_OFFENSIVE_WEIGHT = 0.25
V11_FORMULA_DEFENSIVE_WEIGHT = 0.22
V11_FORMULA_SPLIT_WEIGHT = 0.13
V11_FORMULA_RECENT_WEIGHT = 0.15
V11_FORMULA_XG_WEIGHT = 0.12
V11_FORMULA_PLAYER_WEIGHT = 0.13
