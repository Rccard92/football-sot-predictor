...
V11_MODEL_STAGE = "offensive_plus_opponent_defense_plus_home_away_split_plus_recent_form"
V11_MIN_COMPLETED_MATCHES = 5
V11_MIN_SPLIT_MATCHES = 5
V11_MIN_RECENT_MATCHES = 5
V11_FORMULA_OFFENSIVE_WEIGHT = 0.35
V11_FORMULA_DEFENSIVE_WEIGHT = 0.30
V11_FORMULA_SPLIT_WEIGHT = 0.15
V11_FORMULA_RECENT_WEIGHT = 0.20
