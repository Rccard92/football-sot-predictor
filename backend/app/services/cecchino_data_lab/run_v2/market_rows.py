        ...
        rows.append(
            {
                ...
                "buyability_gate_status": purch.get("gate_status"),
                "buyability_gate_reason_codes": purch.get("gate_reason_codes"),
                "fair_book_probability": _as_float(purch.get("fair_book_probability")),
                "fair_book_probability_source": purch.get("fair_book_probability_source"),
