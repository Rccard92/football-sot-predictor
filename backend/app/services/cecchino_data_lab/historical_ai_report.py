...
def write_historical_report_zip(
    ...
    *,
    ...
    manifest = {
        ...
        "quote_policy": (run.quote_policy_json or {}).get("version") or HISTORICAL_QUOTE_POLICY_VERSION,
        "quote_reference_timing": (run.quote_policy_json or {}).get("reference_timing"),
