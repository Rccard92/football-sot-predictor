...
def accordion_summary_from_models(
    ...
    *,
    ...
    # Nota: questa mappa deve essere robusta (nessun crash se in futuro appare un model_key nuovo).
    # Usiamo MODEL_LABELS come fonte principale e fallback sul model_key stesso.
    labels = {
        BASELINE_SOT_MODEL_VERSION_V11_SOT: MODEL_LABELS.get(BASELINE_SOT_MODEL_VERSION_V11_SOT, BASELINE_SOT_MODEL_VERSION_V11_SOT),
        BASELINE_SOT_MODEL_VERSION_V20_LINEUP_IMPACT: MODEL_LABELS.get(BASELINE_SOT_MODEL_VERSION_V20_LINEUP_IMPACT, BASELINE_SOT_MODEL_VERSION_V20_LINEUP_IMPACT),
        BASELINE_SOT_MODEL_VERSION_V21_WEIGHTED_COMPONENTS: MODEL_LABELS.get(BASELINE_SOT_MODEL_VERSION_V21_WEIGHTED_COMPONENTS, BASELINE_SOT_MODEL_VERSION_V21_WEIGHTED_COMPONENTS),
        BASELINE_SOT_MODEL_VERSION_V30_VALUE_SELECTOR: MODEL_LABELS.get(BASELINE_SOT_MODEL_VERSION_V30_VALUE_SELECTOR, BASELINE_SOT_MODEL_VERSION_V30_VALUE_SELECTOR),
    }
    out: dict[str, str] = {}
