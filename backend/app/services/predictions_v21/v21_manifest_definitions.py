...
V21_MANIFEST_DEFINITIONS: tuple[V21MacroAreaSpec, ...] = (
    ...
    V21MacroAreaSpec(
        ...
        micros=(
            ...
            _micro("top_shooter_absence", "Assenza dei top shooter", 18, "lineup_impact.top_shooter_absence"),
        ),
    ),
    V21MacroAreaSpec(
        key="lineups",
    ...
    V21MacroAreaSpec(
        ...
        micros=(
            ...
            _micro("top_shooter_absence", "Assenza top shooter", 16, "lineup_impact.top_shooter_absence"),
