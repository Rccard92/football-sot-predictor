...
def generate_serie_a_predictions_v10_sot(
    ...
    payload = {
        ...
        "predictions_created_or_updated": int(summary.get("predictions_created_or_updated") or 0),
        "xg_applied_count": int(summary.get("xg_applied_count") or 0),
        "xg_fallback_count": int(summary.get("xg_fallback_count") or 0),
        "aligned_base_terms_count": int(summary.get("aligned_base_terms_count") or 0),
...
def generate_serie_a_predictions_v11_sot(
    ...
    payload = {
        ...
        "formula_terms_count": int(summary.get("formula_terms_count") or 6),
        "architecture": str(summary.get("architecture") or svc.architecture),
        "upcoming_fixtures": int(summary.get("upcoming_fixtures") or 0),
        "predictions_created_or_updated": int(summary.get("predictions_created_or_updated") or 0),
