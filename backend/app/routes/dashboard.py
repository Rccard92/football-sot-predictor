...
def serie_a_dashboard(season: int, db: Session = Depends(get_db)) -> SerieADashboardResponse:
    ...
    return SerieADashboardResponse(
        ...
        fixtures_with_player_stats=int(data.get("fixtures_with_player_stats", 0)),
        player_stats_rows_total=int(data.get("player_stats_rows_total", 0)),
        player_stats_coverage_pct=float(data.get("player_stats_coverage_pct", 0.0)),
        fixtures_with_lineups=int(data.get("fixtures_with_lineups", 0)),
        lineups_rows_total=int(data.get("lineups_rows_total", 0)),
