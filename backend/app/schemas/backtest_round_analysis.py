...
MODEL_API_ALIASES: dict[str, str] = {
    ...
    "baseline_v3_0_sot_value_selector": BASELINE_SOT_MODEL_VERSION_V30_VALUE_SELECTOR,
    "baseline_v3_1_sot_calibrated_predictor": BASELINE_SOT_MODEL_VERSION_V31_CALIBRATED_PREDICTOR,
}
...
MODEL_LABELS: dict[str, str] = {
    ...
    BASELINE_SOT_MODEL_VERSION_V31_CALIBRATED_PREDICTOR: "v3.1 SOT Calibrated Predictor",
}
