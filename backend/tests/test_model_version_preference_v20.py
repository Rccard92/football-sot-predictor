...
def test_preferred_model_versions_ui_only_v20_v11() -> None:
...
def test_preference_order_v20_first() -> None:
    assert MODEL_VERSION_PREFERENCE_ORDER[0] == BASELINE_SOT_MODEL_VERSION_V20_LINEUP_IMPACT
    assert MODEL_VERSION_PREFERENCE_ORDER[1] == BASELINE_SOT_MODEL_VERSION_V11_SOT
