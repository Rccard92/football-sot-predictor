...
> **Nota research Indice di Acquistabilità (Fase 1 / 1.1 / 2A / 2A.1 / 2A.2 / 2A.3):** variabili KPI in audit v1_1; statistica OOF paired e indipendenza vs Book (`statistical_research_v2a_2`); esecuzione FE via job async process-local (2A.3) senza promuovere feature al registry produttivo SOT. **Non** Indice 0–100.
