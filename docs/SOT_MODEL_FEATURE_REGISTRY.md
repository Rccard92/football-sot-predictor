...
> **Nota research Indice di Acquistabilità (Fase 1 / 1.1 / 2A / 2A.1 / 2A.2 / 2A.3 / 2A.3.1):** audit v1_1; statistica OOF paired `v2a_2`; job async + FE result completo; assi effect/temporal/market. **Non** Indice 0–100 né feature registry produttivo SOT.
