...
> **Nota research Indice di Acquistabilità (Fase 1 / 1.1 / 2A / 2A.1 / 2A.2):** variabili KPI in audit v1_1; Fase 2A.2 valuta contributo OOF paired e indipendenza vs Book (`statistical_research_v2a_2`) senza promuovere feature al registry produttivo SOT. **Non** Indice 0–100.
