...
> **Nota Affidabilità storica / Acquistabilità (FASE 1/5):** audit v1_1; statistica OOF `v2a_2`; residual `v2a_4_1`; colonna KPI = **Affidabilità storica** `cecchino_historical_reliability_v1_1` (ex empirica; formula invariata; non probabilità, non stake). Contratto Acquistabilità preview senza score. **Non** Indice ML né feature registry produttivo SOT.
