...
- Monitoraggio Segnali — pagina aggregata `/monitoraggio-segnali` (heatmap UNDER/OVER 2.5, KPI con media segnali/partita Fase 35, export CSV, backfill storico, pulsante «Ricalcola mapping segnali», diagnostics legacy SCALA Fase 38)
