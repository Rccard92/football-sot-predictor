...
- Cecchino Today — dashboard giornaliera Betfair-only, KPI v2 con rating 0-100, quote book da raw/snapshot (Fase 21), layout 32/68, timeline ±7, scan async (`/cecchino-today`)
