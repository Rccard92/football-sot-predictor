...
### Cecchino Today (dashboard giornaliera persistente)

```
POST /api/admin/cecchino/today/scan-day
Body: { "date": "YYYY-MM-DD", "timezone": "Europe/Rome", "force_rescan": false }
POST /api/admin/cecchino/today/update-results
Body: { "date": "YYYY-MM-DD", "timezone": "Europe/Rome" }
