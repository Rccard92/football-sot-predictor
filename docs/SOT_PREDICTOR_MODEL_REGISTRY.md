...
| Aggregator | `cecchino_bet_builder_opportunity_aggregator_v2` (price = V3.1 theoretical gate) |
| Price method | `v31_theoretical_gate_v1` |
...
| Artefatto | Versione / note |
|-----------|-----------------|
| Export pack | `cecchino_module_monitoring_exports_v12` |
